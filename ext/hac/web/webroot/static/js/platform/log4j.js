				...
				if (!!data.loggers) {
                    ...
                    $.each(data.loggers, function (index, logger) {
                        ...
                        $.each(data.levels, function(index, level) {
							...
							{
                                select.append($('<option selected="selected">').val(sanitizeInput(level.standardLevel)).text(level.standardLevel));
							} else {
                                select.append($('<option>').val(sanitizeInput(level.standardLevel)).text(level.standardLevel));
                            }
                        });
