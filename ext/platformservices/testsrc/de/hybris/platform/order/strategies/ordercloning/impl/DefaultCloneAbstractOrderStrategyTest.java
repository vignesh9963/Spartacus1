...
public class DefaultCloneAbstractOrderStrategyTest
{
	...
	public void setup()
	{
		...
		when(itemModelCloneCreator.copy(nullable(ComposedTypeModel.class), eq(sourceOrder), nullable(CopyContext.class)))
	...
	{
		Mockito.lenient().when(itemModelCloneCreator.copyAll(any(), any())).thenReturn(new ArrayList<>());
