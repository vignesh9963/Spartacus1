...
public class AbstractConverterUnitTest
{
	...
	public void testMockitoVsConverterSanityCheck()
	{
		...
		final DummyConverterForMockito conv = new DummyConverterForMockito();

		final List<AtomicInteger> tgtList = conv.convertAll(Collections.singletonList(src));
	...
	public void testMockitoVsConverters()
	{
		...
		final List<AtomicInteger> tgtList = Converters.convertAll(Collections.singletonList(src), converter);
	...
	public void testConvertAll()
	{
		...
		final TestClassForConversion objectA = new TestClassForConversion();
		objectA.setName(OBJECT_A_NAME);
		final TestClassForConversion objectB = new TestClassForConversion();
