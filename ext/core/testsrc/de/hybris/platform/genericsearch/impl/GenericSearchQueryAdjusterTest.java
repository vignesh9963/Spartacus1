...
public class GenericSearchQueryAdjusterTest
{
	...
	public void testAdjustCLOBAttributeOrderByInOracle()
	{
		...
		Mockito.lenient()
		       .doReturn(false)
		       .when(queryAdjusterSpy)
		       .shouldAdjustBlobOrderByForHana(field.getTypeIdentifier(), field.getQualifier());
		Mockito.doReturn(true)
		       .when(queryAdjusterSpy)
		       .shouldAdjustBlobOrderByForOracle(field.getTypeIdentifier(), field.getQualifier());
