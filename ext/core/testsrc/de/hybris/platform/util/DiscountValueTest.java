...
public class DiscountValueTest
{
	...
	@Test
	public void testEqualsIgnoreAppliedValue()
	{
		DiscountValue dv1 = new DiscountValue("test", 9, true, 18, "USD");
		DiscountValue dv2 = new DiscountValue("test", 9, true, 27, "USD");
		assertTrue("DiscountValues aren't equal but should be", dv1.equalsIgnoreAppliedValue(dv2));
		dv1 = new DiscountValue("test", 9, true, 18, "USD");
		dv2 = new DiscountValue("test", 9, true, 27, "EUR");
		assertFalse("DiscountValues are equal but shouldn't be", dv1.equalsIgnoreAppliedValue(dv2));
	}
	...
	public void testTargetPriceMultipleTimes()
	{
		...
		double total = new BigDecimal("199.90").doubleValue() - all_applied.get(0).getAppliedValue() - all_applied.get(1)
		                                                                                                          .getAppliedValue();
