...
public class HybrisLog4j2LoggerTest
{
	...
	private static class LogLevelArgumentMatcher implements ArgumentMatcher<HybrisLoggingEvent>
	{
		...
		@Override
		public boolean matches(final HybrisLoggingEvent hybrisLoggingEvent)
		{
			return hybrisLoggingEvent.getLevel().equals(level);
		}
	}
