...
public class ResourcesGuardServiceTest
{
	...
	@Test
	public void shouldHavePathDisabledIfItIsConfiguredToBeDisabled_CheckWithMatrixVariables()
	{
		// given
		final String extName = "hac";
		final String resourcePath = "/platform/init";
		final String params = ";someParam=foo;someParam1=foo1";
		final ResourcesGuardService service = havingConfigForExtension(extName) //
		                                                                        .withResourceDisabled(resourcePath) //
		                                                                        .getService();

		// when
		final boolean resourceDisabled = service.isResourceDisabled(extName, resourcePath + params);
		// then
		assertThat(resourceDisabled).isTrue();
	}

	@Test
	public void shouldHavePathDisabledIfItIsConfiguredToBeDisabled_CheckWithSemicolonAndParams()
	{
		// given
		final String extName = "hac";
		final String resourcePath = "/platform/init";
	...
	@Test
	public void shouldHavePathDisabledIfItIsConfiguredToBeDisabled_CheckWithParamsAndSemicolon()
	{
		// given
		final String extName = "hac";
		final String resourcePath = "/platform/init";
	...
	@Test
	public void shouldHavePathDisabledIfItIsConfiguredToBeDisabled_CheckWithSemicolonOnly()
	{
		// given
		final String extName = "hac";
		final String resourcePath = "/platform/init";
	...
	@Test
	public void shouldHavePathDisabledIfItIsConfiguredToBeDisabled_CheckTamperedUrl1()
	{
		// given
		final String extName = "hac";
		final String resourcePath = "/platform/init";
		final String tamperedUrl = "/platform;/init";
		final ResourcesGuardService service = havingConfigForExtension(extName) //
		                                                                        .withResourceDisabled(resourcePath) //
		                                                                        .getService();

		// when
		final boolean resourceDisabled = service.isResourceDisabled(extName, tamperedUrl);
		// then
		assertThat(resourceDisabled).isTrue();
	}

	@Test
	public void shouldHavePathDisabledIfItIsConfiguredToBeDisabled_CheckTamperedUrl2()
	{
		// given
		final String extName = "hac";
		final String resourcePath = "/platform/init";
	...
	@Test
	public void shouldHavePathDisabledIfItIsConfiguredToBeDisabled_CheckTamperedUrl3()
	{
		// given
		final String extName = "hac";
		final String resourcePath = "/platform/init";
	...
	@Test
	public void shouldHavePathDisabledIfItIsConfiguredToBeDisabled_CheckTamperedUrl4()
	{
		// given
		final String extName = "hac";
		final String resourcePath = "/platform/init";
	...
	@Test
	public void shouldHavePathDisabledIfItIsConfiguredToBeDisabled_CheckTamperedUrl5()
	{
		// given
		final String extName = "hac";
		final String resourcePath = "/platform/init";
