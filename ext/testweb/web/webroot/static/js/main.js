$(function () {
    ...
    $('body').on("click", '.test-cases-toggle', function () {
        ...
        var contentContainerId = sanitizeInput($(toggleImg).attr('data-contentContainerId'));
    ...
    $('.testSuite').click(function () {
        var contentContainerId = sanitizeInput($(this).attr('data-contentContainerId'));
    ...
    $('.toggleTestCases').click(function () {
        var testCasesContainerClass = sanitizeInput($(this).attr('data-testCasesClass'));
